...
<head>
  <title>Aplikasi Enkripsi dan Dekripsi Celebes Konstruksindo PT</title>
  <meta charset="utf-8">
...
<body>
  ...
  <section class="login-content">
    <div class="logo">
      <h1>Celebes Konstruksindo PT</h1>
    </div>
    <div class="login-box">
      <form class="login-form" action="auth.php" method="post">
        ...
        <div class="form-group btn-container">
          ...
          <p style="font-size:10pt">Copyright <?= date('Y') ?> - Celebes Konstruksindo PT</p>
        </div>
      </form>
    </div>
  </section>
